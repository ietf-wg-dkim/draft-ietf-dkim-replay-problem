...
list and review the [working group home page](https://datatracker.ietf.org/wg/dkim/documents/). If you're
...
list](https://www.ietf.org/mailman/listinfo/dkim). This will ensure that
